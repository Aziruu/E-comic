            ...
            @method('PUT') <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="release_date" class="form-control"
                                        value="{{ $book->release_date ? $book->release_date->format('Y-m-d') : '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <select name="status_release" class="form-select text-success fw-bold">
                                        @foreach (['Ongoing', 'Completed', 'Hiatus', 'Cancelled'] as $status)
                                            <option value="{{ $status }}"
                                                {{ $book->status_release == $status ? 'selected' : '' }}>
                                                {{ $status }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="rating" class="form-control" step="0.1"
                                        min="0" max="10" value="{{ old('rating', $book->rating) }}">
                                </div>
                            </div>
                    ...
                    <div class="d-grid gap-2 mt-4">
                        <button type="submit" class="btn btn-edit-custom btn-lg shadow-sm radius-8">Update Manga</button>
